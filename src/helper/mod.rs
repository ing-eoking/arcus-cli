...
pub fn arcus_hints() -> Vec<CMDHint> {
    let mut hints = vec![
        ...
        ("scrub [stale]", "scrub"),
        ("stats [settings|items|slabs|prefixes|scrub|zookeeper|persistence]", "stats"),
        ("stats cachedump <slab_clsid> <limit> [forward|backward [sticky]]", "stats cachedump"),
        ("stats detail [on|off|dump]", "stats detail"),
        ...
        ("config max_stats_prefixes [<value>]", "config max_stats_prefixes"),
        ("config scrub_count [<scrub_count>]", "config scrub_count"),
        ("config chkpt_interval_pct_snapshot [<percentage(%)>]", "config chkpt_interval_pct_snapshot"),
        ("config chkpt_interval_min_logsize [<minsize(MB)>]", "config chkpt_interval_min_logsize"),
        ("config async_logging [on|off]", "config async_logging"),
        ("cmdlog start [<log_file_path>]", "cmdlog start"),
        ("cmdlog stop", "cmdlog stop"),
        ("cmdlog stats", "cmdlog stats"),
        ("dump start key [<prefix>] <filepath>", "dump start key"),
        ("dump stop", "dump stop"),
        ("lqdetect start [<detect_threshold>]", "lqdetect start"),
        ("lqdetect stop", "lqdetect stop"),
        ("lqdetect show", "lqdetect show"),
        ("lqdetect stats", "lqdetect stats"),
